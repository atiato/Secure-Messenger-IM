...
public class RemoveMembersSelectionList extends ListActivity {
...
//	private static final int DISCARD_ID = 1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		friendUsernames = names.split(",");
		 ...
		 groupowner=extras.getString(GroupInfo.USER);
	...
	public boolean onCreateOptionsMenu(Menu menu) {		
		...
		MenuItem menud = menu.add(0, APPROVE_SELECTED_FRIENDS_ID, 0, "Remove Members").setEnabled(false);
		menu.add(0, SELECTALL_ID, 0, "Check All");
		menu.add(0, UNSELECTALL_ID, 0, "UnCheck All");
		
		if (groupowner.equals(username))
			menud.setEnabled(true);
			...
			//		}					
				...
				Thread thread = new Thread(){
					...
					public void run() {
						...
						{
							try {
							result=	imService.RemoveMembers(username,"password",SelctedGroupmembers, groupname,username);
							...
							if (result.equals("5"))
						{
								...
								Toast.makeText(RemoveMembersSelectionList.this, "Group already exist so please select another name", Toast.LENGTH_SHORT).show();	
									}
									});
									...
									}	else if (result.equals("1"))
						{
							...
							Toast.makeText(RemoveMembersSelectionList.this, "Members have been removed Successfully", Toast.LENGTH_SHORT).show();	
											}
										});
						}else if (result.equals("0"))
						{
							...
							Toast.makeText(RemoveMembersSelectionList.this, "Unable to Remove Members Please check connection", Toast.LENGTH_SHORT).show();	
								}
							});
	...
	{
		super.onResume();
		bindService(new Intent(RemoveMembersSelectionList.this, IMService.class), mConnection , Context.BIND_AUTO_CREATE);
	}
	...
	private ServiceConnection mConnection = new ServiceConnection() {
		...
		public void onServiceDisconnected(ComponentName className) {          
			imService = null;
			Toast.makeText(RemoveMembersSelectionList.this, R.string.local_service_stopped,
