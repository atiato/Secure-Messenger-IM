...
//	private static final String SERVER_RES_SIGN_UP_FAILED = "0";
    ...
    public native String  writeToFile(String path,String pin);
	...
	public void onCreate(Bundle savedInstanceState) {
	        ...
	        pin1 =(EditText) findViewById(R.id.pin);
		    ...
		    LinearLayout layout = (LinearLayout) findViewById(R.id.SUlinearLayout);
							...
							)
					{
						...
						if (passwordText.getText().toString().equals(passwordAgainText.getText().toString())){
							...
							if (usernameText.length() >= 5 && passwordText.length() >= 5) {
							    ...
							    SecretKeySpec sks=Gen(pin1.getText().toString());
						        
						        final String key=Base64.encodeToString(sks.getEncoded(), Base64.DEFAULT);
						...
						/*        runOnUiThread(new Runnable() {
						    ...
						    //    String output = writeToFile(baseDir+File.separator+"atiato.prop",key);
					            
					            String output = writeToFile(baseDir,key);
						        
						        if (output.equals("File written successfully!"))
						        {
	...
	public SecretKeySpec Gen(String seed)
	{
