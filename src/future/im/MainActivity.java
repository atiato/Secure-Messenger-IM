...
private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName className) {
        	imService = null;
            Toast.makeText(MainActivity.this, R.string.local_service_stopped,
					...
					Thread thread = new Thread(){					
						public void run() {
							try {
								...
								if (imService.sendMessage(username, friend, IMKeys.Encrypt(sks,messageText.getText().toString()),EncryptKey(Base64.encodeToString(sks.getEncoded(), Base64.DEFAULT)),""+msgid,"notseen") == null)
								{
